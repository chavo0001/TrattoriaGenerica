    ...
    <>
      {open && (
        <button
          ...
          className="fixed inset-0 z-[45] bg-ink/75 backdrop-blur-xl lg:hidden"
      ...
      <header
        className={cn(
          ...
          open
            ? "border-b border-cream/10 bg-ink/95"
            : scrolled
              ? "border-b border-cream/10 bg-ink/85 backdrop-blur-md"
              : "bg-transparent",
        )}
      >
        <div className="relative z-20 mx-auto flex max-w-7xl items-center justify-between px-5 py-5 lg:px-12">
        ...
        {open && (
          <div className="relative z-20 max-h-[calc(100svh-5.5rem)] overflow-y-auto border-t border-cream/10 bg-ink/95 lg:hidden">
            <div className="flex flex-col gap-1 px-5 py-6">
              {links.map((l) => (
                <a
                  ...
                  href={l.href}
                  onClick={() => setOpen(false)}
                  className="border-b border-cream/10 py-3 text-base tracking-wide text-cream/90"
                >
                  {l.label}
                </a>
              ))}
